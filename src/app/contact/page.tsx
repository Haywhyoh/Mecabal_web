    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-br from-green-50 to-emerald-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Get in touch with the MeCabal team. We're here to help!
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+2348142064474" className="text-gray-600 hover:text-green-600">
                      +234 814 206 4474
                    </a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@mecabal.com" className="text-gray-600 hover:text-green-600">
                      support@mecabal.com
                    </a>
                  </div>
                </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-green-600 text-white text-lg rounded-full hover:bg-green-700 transition-all duration-200 font-medium flex items-center justify-center gap-2"
                >
